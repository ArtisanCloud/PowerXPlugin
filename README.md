...
- **Framework 业务模块接入**：[统一指南](./docs/guides/features/009-consume-powerx-capability/guide.md)；[Customer 基础资料与 Contact Runtime](./docs/guides/features/009-consume-powerx-capability/usecase-customer-contact.md)
