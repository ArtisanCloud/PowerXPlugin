...
func (g *knowledgeGatewayStub) ListPlatformCapabilityCatalog(context.Context, capgateway.ListPlatformCapabilityCatalogOptions) ([]capgateway.PlatformCapabilityCatalogRecord, error) {
	return nil, nil
}
