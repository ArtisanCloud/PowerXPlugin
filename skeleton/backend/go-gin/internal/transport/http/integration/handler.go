...
func (h *Handler) buildDispatchService() *integrationService.DispatchService {
	...
	logger := h.logger
	if logger == nil {
		logger = pxlog.WithComponent("integration_http")
	}
...
func (h *Handler) logCapabilityInvokeAttempt(capabilityID, action, preferredProtocol, requestID string, payload map[string]any, headers map[string]string) {
	...
	pxlog.InfoCtx(pxlog.WithLogFields(context.Background(), map[string]interface{}{
		"module":              "integration",
		"biz_scene":           "capability_invoke_attempt",
	...
	}), "capability invoke request accepted")
}
...
func (h *Handler) logCapabilityInvokeSuccess(capabilityID, action, preferredProtocol, requestID string, result *capgateway.InvokeResult) {
	...
	pxlog.InfoCtx(pxlog.WithLogFields(context.Background(), map[string]interface{}{
		"module":             "integration",
		"biz_scene":          "capability_invoke_success",
		"biz_domain":         "integration",
		"component":          "integration_http",
		"capability_id":      capabilityID,
		"action":             action,
...
func (h *Handler) logCapabilityInvokeError(capabilityID, action, preferredProtocol, requestID string, err error) {
	...
	fields := map[string]interface{}{
		"module":             "integration",
		"biz_scene":          "capability_invoke_error",
		"biz_domain":         "integration",
		"component":          "integration_http",
		"capability_id":      capabilityID,
		"action":             action,
	...
	pxlog.ErrorCtx(pxlog.WithLogFields(context.Background(), fields), "capability invoke failed")
}
...
func (h *Handler) logInvokeCORSHeaders(c *gin.Context) {
	...
	pxlog.InfoCtx(pxlog.WithLogFields(context.Background(), map[string]interface{}{
		"module":                         "integration",
		"biz_scene":                      "capability_invoke_response_headers",
		"biz_domain":                     "integration",
		"component":                      "integration_http",
		"origin":                         strings.TrimSpace(c.GetHeader("Origin")),
	...
	}), "capability invoke response headers")
}
