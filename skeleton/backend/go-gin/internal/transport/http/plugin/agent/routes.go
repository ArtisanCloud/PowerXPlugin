...
func RegisterAPIRoutes(rg *gin.RouterGroup, deps *app.Deps) {
	...
	group.POST("/sessions", h.Session)
	group.GET("/sessions", h.Session)
	group.GET("/sessions/:session_uuid", h.Session)
	group.PATCH("/sessions/:session_uuid", h.Session)
	group.DELETE("/sessions/:session_uuid", h.Session)
	group.POST("/sessions/:session_uuid/archive", h.Session)
	group.GET("/sessions/:session_uuid/messages", h.Session)
	group.POST("/sessions/:session_uuid/messages", h.Session)
	group.POST("/sessions/:session_uuid/invocations", h.Session)
	group.GET("/sessions/:session_uuid/invocations/:invocation_uuid", h.Session)
	group.POST("/sessions/:session_uuid/invocations/:invocation_uuid/cancel", h.Session)
	group.GET("/sessions/:session_uuid/invocations/:invocation_uuid/events", h.Session)
}
