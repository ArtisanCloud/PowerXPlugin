...
func TestStreamSSEUsesPluginBackendGateway(t *testing.T) {
	...
	w := httptest.NewRecorder()
	req := httptest.NewRequest(http.MethodGet, "/api/v1/plugin/agent/stream/sse?agent_id=00000000-0000-4000-8000-000000000001&session_id=10000000-0000-4000-8000-000000000101&trace_id=trace_test&q=hello&origin_tenant_uuid=00000000-0000-0000-0000-000000000001", nil)
	router.ServeHTTP(w, req)
...
func TestStreamSSEPrefersExplicitUUIDParams(t *testing.T) {
	...
	require.Equal(t, "00000000-0000-0000-0000-000000000001", gateway.params.OriginTenantUUID)
