      ...
      <div class="flex flex-wrap items-end justify-between gap-4">
        <div class="space-y-1">
          ...
          <p class="text-gray-600 dark:text-gray-300 max-w-2xl">
            Review tenant-issued consent tokens, confirm authorised data scopes,
            and revoke access when obligations change. Token previews are masked
            to avoid accidental PII exposure.
          </p>
        </div>
      </div>
    </header>
        ...
        <template #default>
          <div class="space-y-4">
            ...
            <div v-if="!loading && !rows.length" class="text-center py-10">
              ...
              {{
                tenantUuid
                  ? "No consent tokens found for this tenant."
                  : "Enter a tenant UUID to begin."
              }}
              </p>
            </div>
          </div>
