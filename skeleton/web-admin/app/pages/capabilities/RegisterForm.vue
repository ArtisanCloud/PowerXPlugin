<template>
  <UContainer class="py-10 space-y-8">
    ...
    <UCard :ui="{ body: 'space-y-8' }">
      ...
      <div v-if="loadingTemplate" class="flex items-center justify-center py-16 text-gray-500 dark:text-gray-400">
        {{ $t("common.loading") }}
      </div>
      ...
      <template v-else>
        ...
        <div class="space-y-2">
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <UFormField :label="$t('capabilities.form.scenario')" :description="$t('capabilities.form.scenarioHint')" required>
