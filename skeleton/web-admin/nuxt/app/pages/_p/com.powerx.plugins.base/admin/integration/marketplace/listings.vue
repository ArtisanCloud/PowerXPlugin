    ...
    <div class="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)]">
      <UCard>
        ...
        >
          ...
          <template #ready_checklist_score-cell="{ row }">
      ...
      <div class="space-y-6">
        <UCard v-if="selectedListing">
          ...
          <form class="space-y-4" @submit.prevent="saveListing">
            ...
            <div class="grid gap-4 md:grid-cols-2">
              <UFormField label="Categories (逗号分隔)">
                <UInput v-model="editForm.categories" />
              </UFormField>
              <UFormField label="Tags (逗号分隔)">
                <UInput v-model="editForm.tags" />
              </UFormField>
            </div>

            <UFormField label="Branding Theme (JSON)">
              ...
              <div v-else class="mt-4 space-y-3">
                ...
                >
                  <div class="grid gap-3 md:grid-cols-2">
                    <UFormField label="类型 (logo/cover/screenshot/video)" required>
                      <UInput v-model="asset.asset_type" />
                    </UFormField>
                    <UFormField label="存储地址" required>
                    ...
                    <div class="flex items-center gap-2">
                      <USwitch v-model="asset.is_primary" />
      ...
      <UCard class="w-full max-w-3xl">
        ...
        <form class="space-y-4" @submit.prevent="submitCreate">
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <UFormField label="Checklist 总结 (可选)">
