        ...
        <div v-else class="space-y-4">
          ...
          <div v-if="currentPlan" class="space-y-6">
            ...
            <div class="grid gap-4 md:grid-cols-2">
              <UFormField label="Plan Code" required>
                <UInput v-model="currentPlan.plan_code" placeholder="enterprise" />
              </UFormField>
              <UFormField label="Plan 类型" required>
              ...
              <div v-else class="space-y-3">
                ...
                >
                  <div class="grid gap-3 md:grid-cols-2">
                    ...
                    <UFormField label="Range From" required>
                      <UInput v-model="tier.range_from" type="number" min="0" />
                    </UFormField>
                    <UFormField label="Range To">
                      <UInput v-model="tier.range_to" type="number" min="0" />
                    </UFormField>
                    <UFormField label="Unit Amount" required>
