    ...
    <UModal v-model:open="publishOpen">
      <UCard>
        ...
        <form class="space-y-4" @submit.prevent="submitPublish">
          <UFormField label="Patched in Version" required>
            <UInput v-model="publishForm.patchedInVersion" placeholder="2.0.1" />
          </UFormField>
          <UFormField label="Notify Channels" help="Choose delivery channels for this advisory">
            <USelectMenu
