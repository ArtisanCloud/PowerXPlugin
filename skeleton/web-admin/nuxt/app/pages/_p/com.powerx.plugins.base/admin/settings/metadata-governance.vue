    ...
    <UCard>
        ...
        <div class="min-w-0 rounded-lg border border-gray-200 dark:border-gray-800">
          <div class="border-b border-gray-200 px-4 py-3 dark:border-gray-800">
            <div class="flex items-center justify-between gap-3">
              ...
              <UButton size="xs" variant="soft" icon="i-heroicons-plus" :disabled="isReadOnly" @click="openCreate('dictionaryNamespace')">
        ...
        <div class="min-w-0 rounded-lg border border-gray-200 dark:border-gray-800">
          <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-800">
            ...
            <UButton
              ...
              :disabled="!selectedDictionary || isReadOnly"
        ...
        <div class="min-w-0 rounded-lg border border-gray-200 dark:border-gray-800">
          <div class="border-b border-gray-200 px-4 py-3 dark:border-gray-800">
            <div class="flex items-center justify-between gap-3">
              ...
              <UButton size="xs" variant="soft" icon="i-heroicons-plus" :disabled="isReadOnly" @click="openCreate('taxonomy')">
        ...
        <div class="min-w-0 rounded-lg border border-gray-200 dark:border-gray-800">
          <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-800">
            ...
            <UButton
              ...
              variant="soft"
              icon="i-heroicons-plus"
              :disabled="!selectedTaxonomy || isReadOnly"
      ...
      <div v-else-if="activeTab === 'tags'" class="space-y-3">
        <div class="flex justify-end">
          <UButton size="sm" variant="soft" icon="i-heroicons-plus" :disabled="isReadOnly" @click="openCreate('tag')">
      ...
      <div v-else class="space-y-3">
        <div class="flex justify-end">
          <UButton size="sm" variant="soft" icon="i-heroicons-plus" :disabled="isReadOnly" @click="openCreate('resourceType')">
...
async function loadMode() {
  try {
    ...
    providerMode.value = normalizeProviderMode(res.data);
    runtimeMode.value = providerMode.value.mode;
  } catch {
